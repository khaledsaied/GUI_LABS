...
*/
			...
			Console.WriteLine("Think of a number between 1 and 100 and I'll try to guess it. Press any key to start");
			Console.ReadKey();
			do
			{
				myGuess =  myRnd.Next(min, max);
				Console.WriteLine("My guess is: " + myGuess);
				Console.WriteLine("Tell me if I'm <H>ight, <L>ow or <E>qual?");
				amIRight = Console.ReadLine().ToUpper();
				...
				{
					Console.WriteLine("Please only input: H, L or E");
				}
