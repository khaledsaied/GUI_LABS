...
namespace AgentAssignment
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            agentCollection.RemoveAt(lbxAgents.SelectedIndex);
        }

        private void DeleteAgent_CanExecute(object sender, CanExecuteRoutedEventArgs e)
        {
            e.CanExecute = agentCollection.Count > 0 && lbxAgents.SelectedIndex >= 0;
        }
        ...
        {
            var view = CollectionViewSource.GetDefaultView(lbxAgents.ItemsSource) as ListCollectionView;
        ...
        private void Filter_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            ListCollectionView view = CollectionViewSource.GetDefaultView(lbxAgents.ItemsSource) as ListCollectionView;
            if (view != null)
            {
