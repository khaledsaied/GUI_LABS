   ...
   public class Agents : ObservableCollection<Agent>, INotifyPropertyChanged
    {
        ...
        public Agents()
        {
            //Add(new Agent("007", "Bo", "spec", "opgav"));
            //Add(new Agent("911", "KS", "speciale", "opgaverre"));
        }
        ...
        private void DeleteAgent()
        {
            ...
            {
                MessageBox.Show("You have not selected a valid item! Choose the item you want to delete",
       ...
       {
           get { return _EditCommand ?? (_EditCommand = new RelayCommand(EditCommand_Execute)); }
       }
       ...
       private void EditCommand_Execute()
       {
           ...
           //MessageBox.Show("EDIT DATA HERE!");
       }
